...
```{r read data}
air_travel <- read.csv(
  file="~/Desktop/UZH/MSc Geographie/2. Semester/GEO885 - GIS Science Project/GEO885/Data and Code/GIUZ_AirTravel_20210509/AIRTRAVELS.csv",
  header = T, sep = ",", stringsAsFactors = F)

staff <- read.csv(
  file="~/Desktop/UZH/MSc Geographie/2. Semester/GEO885 - GIS Science Project/GEO885/Data and Code/GIUZ_AirTravel_20210509/DIVISION_STAFF_COUNT.csv",
  header = T, sep = ",", stringsAsFactors = F)

iata_codes <- read.csv(
  file = "~/Desktop/UZH/MSc Geographie/2. Semester/GEO885 - GIS Science Project/GEO885/Data and Code/GIUZ_AirTravel_20210509/airports.csv",
