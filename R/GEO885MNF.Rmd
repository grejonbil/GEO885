...
aggregated_uzh_regular$total_emission_3y_mean - aggregated_uzh_economy$total_emission_3y_mean #Emissions difference
...
```
```{r}
ggregated_uzh_regular$total_emission_3y_mean
